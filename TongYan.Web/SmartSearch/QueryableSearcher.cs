...
using TongYan.Web.SmartSearch.TransformProviders;
...
namespace TongYan.Web.SmartSearch
{
    internal class QueryableSearcher<T>
    {
        ...
        private static LambdaExpression GetPropertyLambdaExpression(ConditionItem item, ParameterExpression param)
        {
        ...
        public static object ChangeType(object value, Type conversionType)
        {
            ...
            return Convert.ChangeType(value, conversionType.GetUnNullableType(), CultureInfo.CurrentCulture);
        }
        ...
        public static Expression ChangeTypeToExpression(ConditionItem item, Type conversionType)
        {
            ...
            var value = elementType.IsEnum
                ? Enum.Parse(elementType, item.Value.ToString())
                : Convert.ChangeType(item.Value, elementType, CultureInfo.CurrentCulture);
